...
final List<Education> educationList = [
  Education(
    description:
        "B.Tech in Electronics and Communication (Kerala University)",
    linkName: "YCET, Kollam, Kerala",
    period: "2012 - 2017",
  ),
  Education(
    description:
        "Open online course on Product Design (Delft University of Technology, Netherlands)",
    linkName: "Delft University of Technology, Netherlands",
    period: "2016 - 2016",
  ),
  Education(
    description:
